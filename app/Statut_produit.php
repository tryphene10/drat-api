...
class Statut_produit extends Model
{
    //
    ...
    public function generateReference(){
        ...
        if(empty($this->attributes['ref'])){
            ...
            while ( Statut_produit::where('ref',$token)->first() instanceof Statut_produit);
    ...
    public function generateAlias($name){
        ...
        if(empty($this->attributes['alias'])){
            ...
            }while(Statut_produit::where('alias',$alias)->first() instanceof Statut_produit);
