...
class Statut_livraison extends Model
{
    ...
    public function generateReference(){
        ...
        if(empty($this->attributes['ref'])){
            ...
            while ( Statut_livraison::where('ref',$token)->first() instanceof Statut_livraison);
    ...
    public function generateAlias($name){
        ...
        if(empty($this->attributes['alias'])){
            ...
            }while(Statut_livraison::where('alias',$alias)->first() instanceof Statut_livraison);
